...
import { CreateGoalData, GoalPriority } from '../../types/goal';
...
export function AddGoalModal({ isOpen, onClose, onSuccess, selectedDate }: AddGoalModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await goalsApi.createGoal({ ...formData, user_id: user.id });
      onSuccess();
      onClose();
    } catch (err: any) {
